...
export default function LoginPage() {
  ...
  const { signIn, user, profile, loading, profileComplete, isVolunteer, isNGO } = useAuth();
  ...
  }, [user, profile, loading, profileComplete, isVolunteer, isNGO, hasRedirected, router]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect will happen automatically via useEffect when profile loads
    } catch (err) {
